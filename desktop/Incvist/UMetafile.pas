...
type
  ...
  protected
    ...
    procedure SetTransparent({%H-}NewValue: Boolean); override;
  ...
  public
    ...
    procedure LoadFromFile(const {%H-}Filename: String); override;
    procedure LoadFromStream({%H-}Stream: TStream); override;
    procedure SaveToFile(const {%H-}Filename: String); override;
...
procedure TMetafile.SetTransparent(NewValue: Boolean);
begin
end;
